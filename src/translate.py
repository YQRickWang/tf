...
# Directories
tf.app.flags.DEFINE_string("data_dir", os.path.normpath("./data/fly"), "Data directory")
...
tf.app.flags.DEFINE_integer("save_every", 50, "How often to compute error on the test set.")
